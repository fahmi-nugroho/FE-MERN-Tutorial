				...
				<CardBody className="p-8">
					...
					<form className="flex w-80 flex-col gap-4" onSubmit={handleSubmit(handleRegister)}>
						...
						<Controller name="username" control={control} render={({ field }) =>
							<Input {...field} label="Username" type="text" variant="bordered" autoComplete="off" isInvalid={errors.username !== undefined} errorMessage={errors.username?.message} />
						}></Controller>
						<Controller name="email" control={control} render={({ field }) =>
							<Input {...field} label="Email" type="email" variant="bordered" autoComplete="off" isInvalid={errors.email !== undefined} errorMessage={errors.email?.message} />
						}></Controller>
						<Controller name="password" control={control} render={({ field }) =>
							<Input {...field} label="Password" type={visiblePassword.password ? 'text' : 'password'} variant="bordered"
								autoComplete="off"
								endContent={
